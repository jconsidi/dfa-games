  ...
  try
    {
      ...
      // Position 3
      test("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", std::vector<uint64_t>({14, 191, 2812, 43238, 674624}));

      // Position 4
      test("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", std::vector<uint64_t>({6, 264, 9467, 422333}));
      test("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", std::vector<uint64_t>({6, 264, 9467, 422333}));
