...
#ifndef CHESS_DFA_PARAMS_H
#define CHESS_DFA_PARAMS_H

#define CHESS_SQUARE_OFFSET 1
...
#define CHESS_DFA_SHAPE CHESS_DFA_SQUARE_SHAPE
#elif CHESS_SQUARE_OFFSET == 1
#define CHESS_DFA_SHAPE 64, CHESS_DFA_SQUARE_SHAPE
#elif CHESS_SQUARE_OFFSET == 2
#define CHESS_DFA_SHAPE 64, 64, CHESS_DFA_SQUARE_SHAPE
#else
#error
#endif
