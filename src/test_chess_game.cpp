...
int main()
{
  ...
  std::string position_string = chess.position_to_string(chess.get_position_initial());
  ...
  Board black_check_board("rnbq1bnr/ppppkppp/8/4p3/8/BP6/P1PPPPPP/RN1QKBNR b KQkq - 0 1");
